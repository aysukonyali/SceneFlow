...
store_path = '/mmdetection3d/new_sp_normal_flow'
...
class HardVFE(nn.Module):
    ...
    def forward(self,
        ...
        # Step 7 P2_avg + Flow2 to get P1_hat(pred_b)
           ...
           # self.save_point_clouds(first_frame_point_coors_ne,second_frame_point_coors_ne,first_sample_point_coors,pred_f)
    ...
    # # use max_pooling to get the output voxel_wise features
        ...
        # ========================== Save point clouds =========================
    def save_point_clouds(self,first_frame_point_coors_ne, second_frame_point_coors_ne,first_sample_point_coors,pred_f):   
