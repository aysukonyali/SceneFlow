...
class FlowNet3D(nn.Module):
    def __init__(self):
        ...
        self.set_conv1 = SetConv(256, 1.0, 16, 2112, [64, 64, 128]) # we add channel numbers 64+2048 
        ...
        self.set_upconv3 = SetUpConv(8, 256, 2112, [128, 128, 256], [256]) # we add channel numbers 64+2048 
